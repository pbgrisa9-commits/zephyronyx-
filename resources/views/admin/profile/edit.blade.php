...
@section('title', 'Profile Saya - Admin')
                ...
                <div class="pt-2 border-t border-gray-100">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="password" name="password_confirmation" class="mt-1 block w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                </div>
