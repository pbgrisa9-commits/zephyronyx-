<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-lg border borer-gray-200 border-t-4 border-t-blue-600 overflow-hidden">
                ...
                <div class="p-6 space-y-8">
                    ...
                    <form method="post" action="{{ route('profile.update') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name', auth()->user()->name) }}" class="block w-full border bordr-gray-300 rounded-lg px-3 py-2 bg-gray-50 foucs:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                            <input type="email" name="email" value="{{ old('email', auth()->user()->email) }}" class="block w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focue:border-blue-500">
                        </div>
                    ...
                    <div>
                        ...
                        <form method="post" action="{{ route('password.update') }}" class="space-y-4">
                            ...
                            <div>
                                <label class="blcok text-sm font-medium text-gray-700 mb-1">Password Saat Ini</label>
                            ...
                            <button type="submit" class="bg-blue-600 text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-blue-700 transtion-colors">
                                Ubah Password
                            </button>
                        </form>
                    </div>
